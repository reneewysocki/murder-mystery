Murders.bulkCreate([
  ...
  },
  {
    ...
    optionOne: 'Ask him what he is doing in a speedo and if he knows what happened to Jack?',
    optionOneLink: '#',
    optionTwo: 'Realize he is repeating Sport Center stats from 1997 and his head spins around and he asks you if you pulled the latest repository for class…you get freaked out and decide to run towards Deadman.',
    optionTwoLink: '#',
    murderID: '#',
  },
  {
  ...
  },
  {
    ...
    optionOneLink: '#',
    optionTwo: 'You don’t believe Dmitry but you ask him if he has any cash on him, he says yes and begs you to take it, he tells you to trust him.  He hands you $4.29 and you run to Deadman Building',
    optionTwoLink: '#',
    murderID: '#',
  },
  {
    ...
    //ADD LINKS & FIX murderID REPLACE #
    optionOne: 'As you run through Deadman, you stop to take a “Courage Poop” and you find a power cord from class in the bathroom.  It is the larger size one and could be used as a weapon.  You pick it up and continue running towards Basement of Dallas Hall',
    optionOneLink: '#',
    optionTwo: '2.	As you run through Deadman, you get lost and run into Jessica.  Out of nowhere she asks you if your Inspector is open on your browser.  Impatiently she starts to tell you to open your Inspector on your browser, you get nervous and run away from her.  She is fast and starts chasing you.  You run into Rebecca is dog, Tito, wearing a UPS Outfit.  Tito tells you to go down the hallway and go left towards the exit.  Tito also tells you that he will stop Jessica from chasing you, using his cuteness.  As you go down the hallway and turn left, you find a package.  Its from Tito.  Inside is a note.  You continue to the Basement of Dallas Hall',
    optionTwoLink: '#',
    murderID: '#',
  },
  {
  ...
  },
  {
    ...
    //ADD LINKS & FIX murderID REPLACE #
    optionOne: 'Use your picklocking skills that you never thought you would need to use',
    optionOneLink: '#',
  ...
  },
  {
    ...
    //ADD LINKS & FIX murderID REPLACE #
    optionOne: 'Ask Erik to follow you to the basement to investigate what's down there?',
    optionOneLink: '#',
    optionTwo: 'Ask Erik to get help and go to the basement by yourself to investigate what is down there?',
    optionTwoLink: '#',
    murderID: '#',
  },
  {
